...
router.get("/", async (req, res) => {
  ...
  // Math.min -> bring min document form monodb
...
// route of count - the page in the collection in database
...
// adit of device - only by match id
...
// req for delete device only by match id
